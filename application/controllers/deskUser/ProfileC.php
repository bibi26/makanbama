...
class ProfileC extends MY_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('deskUser/profile');
                        ...
                        else
                        {
                            if (file_exists($user_folder))
                            {
                                ...
                                $output = [
                                    ...
                                    'initialPreviewConfig' => [ [ 'url' => base_url() . "deskUser/profileC/uploadImgProfile/delete"]],
                                    'append' => FALSE
                                ];
                                die(json_encode($output));
                            }
                            else
                            {
                                ...
                                $output = [
                                    'uploaded' => 'OK',
                                    'initialPreview' => [base_url() . "assets/img/upload/{$user}/{$filename}?{$nc}"],
                                    'initialPreviewConfig' => [ [ 'url' => base_url() . "deskUser/editVisuC/uploadImgProfile/delete"],],
                                    'append' => FALSE
                                ];
                                die(json_encode($output));
                            }
