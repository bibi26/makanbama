...
|
*/
//$enable_dev_server_config = FALSE;
//$dev_server_name = 'http://insurance.loc'; //Replace "localhost" with your dev server name if needed or just use a custom conditional expression.
...
$config['sett_asset_img']	= "/img/";
$config['sett_asset_css']	= "/css/";
$config['sett_asset_js']	= "/";
?>