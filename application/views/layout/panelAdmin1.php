            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion1" href="#collapseOne1" style="font-size: 12px;font-weight: bolder;"><span></span>x</a>
                    </h4>
                </div>
                <div id="collapseOne1" class="panel-collapse collapse in">
                    <ul class="list-group">
                        <li class="list-group-item" id="itemMenuVilla"><span class="glyphicon glyphicon-plus-sign text-primary"></span> <a href="<?php echo base_url() . 'deskAdmin/listItemC/'; ?>" style="font-size:12px;color: black;">ویلا و سوئیت-آپارتمان</a></li>
